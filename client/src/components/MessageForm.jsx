        ...
        <div className="w-full justify-center items-center flex">
          ...
          >
            <div className="flex justify-center items-center w-full">
              <h2 className="w-full text-start text-lg md:text-xl lg:text-xl xl:text-xl 2xl:text-xl font-bold px-3 border-l-2 border-red-600">
                Leave a message
              </h2>
            </div>
            <div className="flex flex-col ">
              ...
              <input
                name="fullName"
                className=" bg-transparent rounded-md border-[1px] border-slate-400 py-3 px-2"
              />
            </div>
            <div className="flex flex-col">
            ...
            <div className="flex flex-col">
              ...
              <textarea
                ...
                cols="30"
                rows="5"
                className="rounded-md bg-transparent border-slate-400"
              ></textarea>
            </div>
            <button
              aria-describedby={id}
